...
import "./App.css";
import icon from "./assets/images/z6318443437947_96cbb004097222a8ef9eef9b68114e3f.jpg";
...
function App() {
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      {/* Navigation */}
      <nav className="bg-blue-300 py-3 mx-4 rounded-lg">
      ...
      <div className="flex mx-4 mt-4">
        ...
        <div className="flex-1 bg-white p-4 rounded-lg shadow-md text-center mx-4 h-35">
          <img src={Test.icon2} alt="Ảnh thương hiệu" className="w-full h-auto rounded-lg" />
        </div>
      </div>
